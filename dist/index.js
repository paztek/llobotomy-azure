...
class Thread extends EventEmitter {
    ...
    async doRun(assistant) {
        ...
        let stream$1;
        try {
            stream$1 = await assistant.streamChatCompletions(messages);
        }
        catch (e) {
...
exports.ContextLengthExceededError = ContextLengthExceededError;
exports.InvalidRequestError = InvalidRequestError;
exports.InvalidToolOutputsError = InvalidToolOutputsError;
exports.RequiredAction = RequiredAction;
exports.Thread = Thread;
exports.ThreadMessageConverter = ThreadMessageConverter;
exports.ToolEmulator = ToolEmulator;
